...
import { IntroSlideProps,IntroSlideData } from "../Interfaces/Interfaces";
import data from '../ElementsData/data.json'

const IntroSlide: React.FC<IntroSlideProps> = ({ setSelectedSlide }) => {
  const [showAnalogy, setShowAnalogy] = useState(false);
  const { content }: IntroSlideData["IntroSlide"] = data.IntroSlide; 
    ...
    <div className="w-full h-full mx-auto flex items-center justify-center">
      <div className="w-full space-y-12 text-center">
        <div className="space-y-2">
          ...
          <h1 className="text-5xl font-bold text-gray-900">{content[0].title}</h1>
        </div>
